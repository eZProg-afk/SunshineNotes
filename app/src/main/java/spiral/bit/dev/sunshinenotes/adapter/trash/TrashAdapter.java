...
public class TrashAdapter extends RecyclerView.Adapter<TrashAdapter.NoteViewHolder> {

    private List<TrashNote> noteInFolders;
    private final TrashListener listener;
    private Timer timer;
    private final List<TrashNote> notesSource;

    public TrashAdapter(List<TrashNote> noteInFolders, TrashListener listener) {
    ...
    public void onBindViewHolder(@NonNull NoteViewHolder holder, final int position) {
        ...
        holder.layoutNote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                listener.onTrashNoteClicked(noteInFolders.get(position), position);
            }
        });
        holder.layoutNote.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                listener.onTrashNoteLongClicked(noteInFolders.get(position), position);
                return true;
            }
        });
    }
    ...
    static class NoteViewHolder extends RecyclerView.ViewHolder {
        ...
        void setNote(TrashNote simpleNote) {
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                if (searchKeyWord.trim().isEmpty()) {
                    ...
                    ArrayList<TrashNote> tempList = new ArrayList<>();
